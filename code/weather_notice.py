...
def weather():
    def night():
        hourly_time=[]
        hourly_rain=[]
        weather_json=req.get("https://api.open-meteo.com/v1/forecast?latitude=xxx&longitude=xxx&timezone=Asia%2FTokyo&daily=temperature_2m_max&daily=temperature_2m_min&daily=precipitation_probability_mean&daily=weathercode&daily=windspeed_10m_max&daily=winddirection_10m_dominant&hourly=relativehumidity_2m&hourly=rain",verify=False)
    ...
    def day():
        hourly_time=[]
        hourly_rain=[]
        weather_json=req.get("https://api.open-meteo.com/v1/forecast?latitude=xxx&longitude=xxx&timezone=Asia%2FTokyo&daily=temperature_2m_max&daily=temperature_2m_min&daily=precipitation_probability_mean&daily=weathercode&daily=windspeed_10m_max&daily=winddirection_10m_dominant&hourly=rain",verify=False)
        weather_json=weather_json.json()
